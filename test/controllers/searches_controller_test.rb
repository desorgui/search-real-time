...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create search' do
    assert_difference('Search.count') do
      post searches_url, params: { search: { search_query: @search.search_query, user_ip: @search.user_ip } }
    end
  ...
  test 'should update search' do
    patch search_url(@search), params: { search: { search_query: @search.search_query, user_ip: @search.user_ip } }
